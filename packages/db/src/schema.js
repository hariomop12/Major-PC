import { boolean, decimal, integer, json, jsonb, pgTable, real, text, timestamp, unique, } from "drizzle-orm/pg-core";
...
const generate = customAlphabet("0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ");
...
export const log = pgTable("log", {
    ...
    tools: json().$type(),
    toolChoice: json().$type(),
    toolResults: json().$type(),
    finishReason: text(),
